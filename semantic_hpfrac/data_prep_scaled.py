...
def main():
    ...
    h1_edges = hop1[['hop1_id', 'hop0_id', 'intent_label']].copy().rename(columns={'hop1_id': 'src', 'hop0_id': 'dst'})
    h2_edges = hop2[['hop2_id', 'hop1_id']].copy().rename(columns={'hop2_id': 'src', 'hop1_id': 'dst'})
